...
// Replace vcl-total, Vql Ut — See README.adoc for details., just run, Vql Ut started successfully. with actuals
= vcl-total — Quick Start for Users
:toc:
:toclevels: 2
...
[source,bash]
----
just install --portable --prefix=./vcl-total-portable
----
