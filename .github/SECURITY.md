...
Replace all {{PLACEHOLDER}} values with your information:
  ...
  https://github.com/hyperpolymath/vql-ut          - Your website/domain
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/vql-ut/security/advisories/new)
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/vql-ut/security/advisories)
...
- [Security Advisories](https://github.com/hyperpolymath/vql-ut/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/vql-ut/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/vql-ut/discussions) |
